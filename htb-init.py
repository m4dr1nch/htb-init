...
def create_dirs() -> None:
    ...
    create_dir(f'/work/ctf/htb/{ARGS["name"]}')
    create_dir(f'/work/ctf/htb/{ARGS["name"]}/scans')
    create_dir(f'/work/ctf/htb/{ARGS["name"]}/scans/nmap')
    ...
    create_dir(f'/work/ctf/htb/{ARGS["name"]}/www')


def update_zshrc() -> None:
    os.system(f'sed -i "s/export IP=\'.*\'/export IP=\'{ARGS["ip"]}\'/g" ~/.zshrc')
    os.system(f'sed -i "s/export CHD=\'.*\'/export CHD=\'\\/work\\/ctf\\/htb\\/{ARGS["name"]}\'/g" ~/.zshrc')
